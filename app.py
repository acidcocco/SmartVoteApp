...
def admin_dashboard():
    ...
    end_time = st.date_input("日期", value=default_end.date())
    end_hour = st.time_input("時間", value=default_end.time())

    combined_end = datetime.combine(end_time, end_hour).astimezone(timezone("Asia/Taipei"))
